...
| NVIDIA integration | Live provider smoke and official BFCL and GSM8K evaluations | NIM requests pass using the Windows User `NVIDIA_API_KEY` environment variable; seven BFCL public category samples and the complete GSM8K test split completed |
