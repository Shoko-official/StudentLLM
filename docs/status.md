...
| --- | --- | --- |
| Application verification | `npm run verify` | TypeScript, benchmark adapter checks, 70 Vitest tests, Vite production build, and 26 Playwright tests pass |
