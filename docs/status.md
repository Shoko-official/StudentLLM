...
| --- | --- | --- |
| Application verification | `npm run verify` | TypeScript, benchmark adapter checks, 66 Vitest tests, Vite production build, and 24 Playwright tests pass |
