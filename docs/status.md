...
| Tauri desktop shell | Rust `cargo check`, native persistence tests, and native-window build path | Shell scaffold and SQLite WAL workspace bridge added; packaged installer, sidecar supervision, and crash-recovery soak remain pending |
