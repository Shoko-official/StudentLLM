...
| BIG-Bench Hard | Official `bbh_zeroshot_logical_deduction_seven_objects` task, 250 public cases through NVIDIA NIM | Flexible-extract exact match `59.20%` (148/250), stderr `0.0311`; one task sample, not a full BBH result |
