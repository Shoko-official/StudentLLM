...
| --- | --- | --- |
| Application verification | `npm run verify`, packaged desktop WebDriver | TypeScript, benchmark adapter checks, 87 Vitest tests, Vite production build, and 31 Playwright tests pass; the dedicated Linux/Windows packaged desktop UI job is configured to exercise course creation, native reload persistence, and Studio artifact persistence |
