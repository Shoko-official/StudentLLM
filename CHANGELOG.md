...
- provider smoke reverified on 2026-08-29 without restarting the local model process: NVIDIA NIM 1,207 ms and LM Studio 61,841 ms with `openai/gpt-oss-20b`;
